...
Viewer::Viewer(mapptr pMap, ccptr pCC,pcmptr pPointCloud)
    : mpMap(pMap),mpCC(pCC),mbDrawFrame(false),mpPointCloudMapping(pPointCloud)
{
    ...
    else
    {
        ...
        *ss << "ServerMapPointsMap0";
        ...
        ss = new stringstream;
         *ss << "densemap" <<1;
        mPubDensePC =mNh.advertise<sensor_msgs::PointCloud2>(ss->str(),10);
        //++++++++++ Map 1 +++++++++
...
pcl::PointXYZRGB Viewer::CreateMP(cv::Mat p3D, size_t nClientId)
{
    pcl::PointXYZRGB p;
